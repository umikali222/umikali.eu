...
function refreshGame(){
    ...
    if (!secondCompany){
        ...
        updateTextContent('vendingMachineProfitPerSec', vendingMachineProfitPerSec)
    ...
    updateVisibilityAndButton('clockUpgrade', clockUpgrade, money >= 10000000)
...
setInterval(minuteClockUpdate, 60000 / clocks)
